...
initializeLevels = do
    ...
    return [ Level 1 level1Items level1Walls 5 10 10,
             Level 2 level2Items level2Walls 10 15 15,
             Level 3 level3Items level3Walls 15 15 15,
             Level 4 level4Items level4Walls 20 20 20,
             Level 5 level5Items level5Walls 25 20 20
           ]
